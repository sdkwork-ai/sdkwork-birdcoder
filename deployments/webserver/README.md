...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 14 | `code-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 14 | `code-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 14 | `code-staging.sdkwork.com` | 80 |
| production | `server.production.toml` | 14 | `code.sdkwork.com` | 443 ssl + 80 |
