...
Module `sdkwork-birdcoder` · runtime code `birdcoder` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `code-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `code-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `code-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 16 | `code-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `code.sdkwork.com` | 443 ssl + 80 |
