...
for (const retiredProjectBindingName of [
  'BIRDCODER_APPBASE_PROJECT_STORAGE_BINDING',
  'BIRDCODER_APPBASE_PROJECT_CONTENT_STORAGE_BINDING',
]) {
  assert.doesNotMatch(
    storageBindingsSource,
    new RegExp(`\\b${retiredProjectBindingName}\\b`, 'u'),
    `BirdCoder project/project_content must have one BirdCoder-owned binding; do not keep duplicate appbase binding ${retiredProjectBindingName}.`,
  );
}
