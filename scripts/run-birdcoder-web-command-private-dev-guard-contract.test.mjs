...
assert.throws(
  () =>
    runBirdcoderWebCommand({
      argv: ['dev', '--iam-mode', 'server-private'],
      spawnSyncImpl: () => {
  ...
  'server-private web dev must not launch the client-only web command because appbase-backed pages require :10240 server readiness.',
);
