...
const crates = [
  {
    ...
    routes: [
      ['Get', 'SYSTEM_DESCRIPTOR_PATH', 'system', 'descriptor.retrieve', 'public'],
      ['Get', 'SYSTEM_ROUTES_PATH', 'system', 'routes.list', 'public'],
      ['Get', 'SYSTEM_RUNTIME_PATH', 'system', 'runtime.retrieve', 'dual_token'],
      ['Get', 'SYSTEM_HEALTH_PATH', 'system', 'health.retrieve', 'public'],
