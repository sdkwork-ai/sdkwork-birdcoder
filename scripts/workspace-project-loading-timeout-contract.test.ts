...
import { hydrateImportedProjectFromAuthority } from '../apps/sdkwork-birdcoder-pc/packages/sdkwork-birdcoder-pc-workbench/src/workbench/importedProjectHydration.ts';
import type { BirdCoderProject } from '../apps/sdkwork-birdcoder-pc/packages/sdkwork-birdcoder-pc-contracts-commons/src/index.ts';
...
const useWorkspacesSource = fs.readFileSync(
  path.join(rootDir, 'apps/sdkwork-birdcoder-pc/packages/sdkwork-birdcoder-pc-workbench/src/hooks/useWorkspaces.ts'),
  'utf8',
);
const useProjectsSource = fs.readFileSync(
  path.join(rootDir, 'apps/sdkwork-birdcoder-pc/packages/sdkwork-birdcoder-pc-workbench/src/hooks/useProjects.ts'),
  'utf8',
);
const importedProjectHydrationSource = fs.readFileSync(
  path.join(rootDir, 'apps/sdkwork-birdcoder-pc/packages/sdkwork-birdcoder-pc-workbench/src/workbench/importedProjectHydration.ts'),
  'utf8',
);
