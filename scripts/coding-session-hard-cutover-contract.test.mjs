...
const typesIndexSource = read('apps/sdkwork-birdcoder-pc/packages/sdkwork-birdcoder-pc-contracts-commons/src/index.ts');
const dataSource = read('apps/sdkwork-birdcoder-pc/packages/sdkwork-birdcoder-pc-contracts-commons/src/data.ts');
...
const commonsIndexSource = read('apps/sdkwork-birdcoder-pc/packages/sdkwork-birdcoder-pc-workbench/src/index.ts');
...
assert.ok(
  !existsSync(new URL('../apps/sdkwork-birdcoder-pc/packages/sdkwork-birdcoder-pc-workbench/src/hooks/useThreadActions.ts', import.meta.url)),
  'legacy useThreadActions hook file must be removed',
);
assert.ok(
  existsSync(new URL('../apps/sdkwork-birdcoder-pc/packages/sdkwork-birdcoder-pc-workbench/src/hooks/useCodingSessionActions.ts', import.meta.url)),
