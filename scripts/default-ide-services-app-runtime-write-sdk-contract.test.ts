...
assert.doesNotMatch(
  ...
  'defaultIdeServices must not import the retired generated app runtime write facade.',
);
...
console.log('default IDE services app runtime SDK write contract passed.');
