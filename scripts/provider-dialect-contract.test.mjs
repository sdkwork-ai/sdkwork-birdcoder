...
for (const [tableName, columnName, nullability] of [
  ...
  ['studio_app', 'status', 'NULL'],
  ['studio_app', 'app_type', 'NULL'],
...
for (const [tableName, columnName, nullability] of [
  ...
  ['studio_app', 'icon', 'NULL'],
  ['studio_app', 'resource_list', 'NULL'],
  ['studio_app', 'config', 'NULL'],
  ['studio_app', 'platforms', 'NULL'],
  ['studio_app', 'install_platforms', 'NULL'],
  ['studio_app', 'install_skill', 'NULL'],
  ['studio_app', 'install_config', 'NULL'],
  ['studio_app', 'release_notes', 'NULL'],
...
for (const [indexName, tableName, columnNames] of [
  ...
  ['idx_studio_app_user_id', 'studio_app', 'user_id'],
  ['idx_studio_app_project_id', 'studio_app', 'project_id'],
  ['idx_studio_app_status', 'studio_app', 'status'],
