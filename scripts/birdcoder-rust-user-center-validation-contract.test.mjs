...
for (const retiredLegacyIdentitySurface of [
  ...
  /upgrade_sqlite_provider_authority_integer_identifier_table/u,
  /ensure_sqlite_provider_authority_integer_identifier_upgrade/u,
  /\bidentity-aware API flows\b/u,
  /__legacy_integer_identifiers/u,
  /legacy_nullable_model_id/u,
  /__legacy_nullable_model_id/u,
  /rewrite_provider_authority_business_tables_to_legacy_text_identifiers/u,
  /CREATE TABLE(?: IF NOT EXISTS)? (?:teams|team_members|workspace_members|project_collaborators)\b/u,
  /\bUSER_CENTER_AUTH_VERIFY_SEND_PATH\b/u,
  /\bUSER_CENTER_AUTH_QR_STATUS_PATH\b/u,
  /\bUSER_CENTER_VIP_INFO_PATH\b/u,
  /\bapp_user_center_login_qr_status\b/u,
]) {
  assert.doesNotMatch(
    libSource,
