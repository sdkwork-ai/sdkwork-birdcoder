...
export const RELEASE_FLOW_CHECK_COMMANDS = [
  ...
  'node scripts/run-local-tsx.mjs scripts/default-ide-services-core-read-service-contract.test.ts',
  'node --experimental-strip-types scripts/coding-server-overview-engine-model-consumer-contract.test.ts',
  'node scripts/run-local-tsx.mjs scripts/api-backed-project-service-core-create-coding-session-contract.test.ts',
  'node scripts/run-local-tsx.mjs scripts/api-backed-project-service-core-create-coding-session-turn-contract.test.ts',
