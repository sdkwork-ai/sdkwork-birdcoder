...
export const RELEASE_FLOW_CHECK_COMMANDS = [
  ...
  'node scripts/run-local-tsx.mjs scripts/shell-runtime-app-client-contract.test.ts',
  'node scripts/run-local-tsx.mjs scripts/server-runtime-transport-contract.test.ts',
  ...
  'node scripts/run-local-tsx.mjs scripts/prompt-skill-template-evidence-consumer-contract.test.ts',
  ...
  'node scripts/run-local-tsx.mjs scripts/app-runtime-write-sdk-client-contract.test.ts',
  'node scripts/run-local-tsx.mjs scripts/app-runtime-read-sdk-client-contract.test.ts',
  'node scripts/run-local-tsx.mjs scripts/app-runtime-projection-read-sdk-client-contract.test.ts',
  'node scripts/run-local-tsx.mjs scripts/app-runtime-sdk-facade-governance-contract.test.ts',
  'node --experimental-strip-types scripts/default-ide-services-split-sdk-client-contract.test.ts',
  'node scripts/run-local-tsx.mjs scripts/default-ide-services-app-runtime-write-sdk-contract.test.ts',
  'node scripts/run-local-tsx.mjs scripts/default-ide-services-app-runtime-read-sdk-contract.test.ts',
  'node scripts/run-local-tsx.mjs scripts/default-ide-services-app-runtime-read-service-contract.test.ts',
  'node --experimental-strip-types scripts/coding-server-overview-engine-model-consumer-contract.test.ts',
  'node scripts/run-local-tsx.mjs scripts/api-backed-project-service-app-runtime-create-coding-session-contract.test.ts',
  'node scripts/run-local-tsx.mjs scripts/api-backed-project-service-app-runtime-create-coding-session-turn-contract.test.ts',
  'node --experimental-strip-types scripts/coding-session-projection-app-consumer-contract.test.ts',
  'node scripts/run-local-tsx.mjs scripts/coding-session-approval-consumer-contract.test.ts',
  ...
  'node scripts/run-cargo.mjs build -p sdkwork-birdcoder-kernel-bridge --bin birdcoder-kernel-turn',
