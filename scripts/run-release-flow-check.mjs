...
export const RELEASE_FLOW_CHECK_LANES = Object.freeze({
  ...
  ownership: Object.freeze([
    ...
    'node scripts/database-baseline-engine-parity-contract.test.mjs',
    'node scripts/materialize-database-contract.test.mjs',
    'node scripts/database-drift-policy-contract.test.mjs',
    'node scripts/repository-soft-delete-dialect-contract.test.mjs',
