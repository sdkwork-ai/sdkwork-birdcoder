...
assert.equal(
  ...
  'Root quality scripts must expose workspace-vs-embedded terminal routing, forced Terminal focus, topbar default paths, embedded terminal close behavior, and executable command-governance enforcement as one first-class standard.',
);
assert.equal(
