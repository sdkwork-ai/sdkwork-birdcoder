...
const sessions = [
  ...
  createAgentSessionFixture({
    ...
    itemCount: '4',
    lastItemSequence: '4',
    lastItemAt: '2026-01-01T00:04:04.000Z',
    version: '4',
    updatedAt: '2026-01-01T00:04:04.000Z',
  }),
  createAgentSessionFixture({
    ...
    itemCount: '2',
    lastItemSequence: '2',
    lastItemAt: '2026-01-01T00:03:02.000Z',
    version: '2',
    updatedAt: '2026-01-01T00:03:02.000Z',
  }),
  ...Array.from({ length: 38 }, (_, index) => {
...
const sessionItemsBySessionId = new Map([
  ...
  [
    ...
    Array.from({ length: 112 }, (_, index) => {
      ...
      const providerItemBySequence = {
        ...
        105: {
          id: 'e2e-codex-command-execution-1',
  ...
  [
    ...
    [
      {
        sessionId: 'e2e-openclaw-session',
        itemId: 'e2e-openclaw-item-4',
        turnId: 'e2e-openclaw-turn-1',
        kind: 'tool_result',
        status: 'failed',
        sequence: '4',
        content: null,
        ...
        toolCallId: 'e2e-openclaw-read-missing',
        toolResult: {
          role: 'toolResult',
          toolCallId: 'e2e-openclaw-read-missing',
          toolName: 'read_file',
          content: [{ type: 'text', text: 'File not found: docs/missing.md' }],
          isError: true,
        },
        createdAt: '2026-01-01T00:04:04.000Z',
        completedAt: '2026-01-01T00:04:04.000Z',
      },
      {
        sessionId: 'e2e-openclaw-session',
        itemId: 'e2e-openclaw-item-3',
        turnId: 'e2e-openclaw-turn-1',
        kind: 'tool_call',
        status: 'completed',
        sequence: '3',
        ...
        toolResult: {
          ...
          content: [{
            type: 'toolCall',
            id: 'e2e-openclaw-read-missing',
            name: 'read_file',
            arguments: { path: 'docs/missing.md' },
          }],
        },
        createdAt: '2026-01-01T00:04:03.000Z',
        completedAt: '2026-01-01T00:04:03.000Z',
      },
      {
        sessionId: 'e2e-openclaw-session',
        itemId: 'e2e-openclaw-item-2',
        turnId: 'e2e-openclaw-turn-1',
        kind: 'tool_result',
        status: 'completed',
        sequence: '2',
        ...
        contentType: 'application/json',
        toolName: 'provider_history',
        toolCallId: 'e2e-openclaw-read-readme',
        toolResult: {
          role: 'toolResult',
          toolCallId: 'e2e-openclaw-read-readme',
          toolName: 'read_file',
          content: [{ type: 'text', text: 'SDKWork BirdCoder provider guide' }],
          isError: false,
        },
        createdAt: '2026-01-01T00:04:02.000Z',
        completedAt: '2026-01-01T00:04:02.000Z',
      },
      {
        sessionId: 'e2e-openclaw-session',
        itemId: 'e2e-openclaw-item-1',
        turnId: 'e2e-openclaw-turn-1',
        kind: 'tool_call',
        status: 'completed',
        sequence: '1',
        ...
        toolResult: {
          ...
          content: [{
            type: 'toolCall',
            id: 'e2e-openclaw-read-readme',
            name: 'read_file',
            arguments: { path: 'README.md' },
          }],
        },
        createdAt: '2026-01-01T00:04:01.000Z',
        completedAt: '2026-01-01T00:04:01.000Z',
      },
    ],
  ],
  [
    ...
    [
      {
        sessionId: 'e2e-hermes-session',
        itemId: 'e2e-hermes-item-2',
        turnId: 'e2e-hermes-turn-1',
        kind: 'tool_result',
        status: 'completed',
        sequence: '2',
        content: null,
        contentType: 'application/json',
        toolName: 'provider_history',
        toolCallId: 'e2e-hermes-mcp-read',
        toolResult: {
          role: 'tool',
          tool_call_id: 'e2e-hermes-mcp-read',
          content: 'Hermes MCP provider specification',
        },
        createdAt: '2026-01-01T00:03:02.000Z',
        completedAt: '2026-01-01T00:03:02.000Z',
      },
      {
        sessionId: 'e2e-hermes-session',
        itemId: 'e2e-hermes-item-1',
        turnId: 'e2e-hermes-turn-1',
        kind: 'tool_call',
        status: 'completed',
        sequence: '1',
        ...
        toolResult: {
          ...
          content: '',
          tool_calls: [{
            id: 'e2e-hermes-mcp-read',
            type: 'function',
            function: {
              name: 'mcp__filesystem__read_file',
              arguments: '{"path":"docs/providers/hermes.md"}',
            },
          }],
        },
