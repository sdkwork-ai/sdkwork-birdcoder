...
export const GOVERNANCE_REGRESSION_CHECKS = [
  ...
  {
    id: 'release-desktop-signing-environment-preflight',
    label: 'Release desktop signing environment preflight contract',
    scriptPath: 'scripts/release/preflight-desktop-signing-environment.test.mjs',
    command: 'node scripts/release/preflight-desktop-signing-environment.test.mjs',
  },
  {
    id: 'release-desktop-installer-trust-verifier',
    label: 'Release desktop installer trust verifier contract',
    scriptPath: 'scripts/release/verify-desktop-installer-trust.test.mjs',
    command: 'node scripts/release/verify-desktop-installer-trust.test.mjs',
  },
  {
  ...
  {
    id: 'release-attestation-evidence',
    label: 'Release attestation evidence contract',
    scriptPath: 'scripts/release/write-attestation-evidence.test.mjs',
    command: 'node scripts/release/write-attestation-evidence.test.mjs',
  },
  {
    id: 'release-checksums',
    label: 'Release checksums publication-view contract',
    scriptPath: 'scripts/release/release-checksums.test.mjs',
    command: 'node scripts/release/release-checksums.test.mjs',
  },
  {
    id: 'release-readiness-assertion',
    label: 'Release readiness assertion contract',
    scriptPath: 'scripts/release/assert-release-readiness.test.mjs',
    command: 'node scripts/release/assert-release-readiness.test.mjs',
  },
  {
    id: 'release-readiness-complete-matrix',
    label: 'Release readiness complete matrix contract',
    scriptPath: 'scripts/release/release-readiness-complete-matrix.test.mjs',
    command: 'node scripts/release/release-readiness-complete-matrix.test.mjs',
  },
  {
    id: 'release-readiness-fixture',
    label: 'Release readiness fixture generator contract',
  ...
  },
  {
    ...
    label: 'Release candidate dry-run evidence contract',
    scriptPath: 'scripts/release/candidate-dry-run.test.mjs',
    command: 'node scripts/release/candidate-dry-run.test.mjs',
  },
  {
    id: 'release-rehearsal-verify',
    label: 'Release rehearsal verification contract',
    scriptPath: 'scripts/release/rehearsal-verify.test.mjs',
    command: 'node scripts/release/rehearsal-verify.test.mjs',
  },
  {
