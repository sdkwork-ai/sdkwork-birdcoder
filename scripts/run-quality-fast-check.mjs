...
export const QUALITY_FAST_CHECK_COMMANDS = Object.freeze([
  ...
  'node scripts/run-workspace-package-script.mjs . test:agents-catalog-sdk-contract',
  ...
  'node scripts/run-workspace-package-script.mjs . test:agent-session-pagination-refresh-contract',
