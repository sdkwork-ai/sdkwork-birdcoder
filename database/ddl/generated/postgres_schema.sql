...
-- Generated at: 2026-07-16T05:12:46.258Z
...
-- baseline source: ddl/baseline/postgres/0001_birdcoder_baseline.sql
...
ON ai_coding_session(tenant_id, project_id, runtime_location_id, updated_at DESC);
...
CREATE TABLE IF NOT EXISTS studio_project_runtime_location (
    ...
    file_system_available BOOLEAN NOT NULL DEFAULT FALSE,
...
CREATE TABLE IF NOT EXISTS ops_project_runtime_location_audit (
    ...
    redacted_metadata_json JSONB NOT NULL
);
...
CREATE TABLE IF NOT EXISTS studio_project_workspace_binding (
    ...
    tenant_id BIGINT NOT NULL DEFAULT 0,
    organization_id BIGINT NOT NULL DEFAULT 0,
    project_id BIGINT NOT NULL REFERENCES studio_project(id) ON DELETE CASCADE,
