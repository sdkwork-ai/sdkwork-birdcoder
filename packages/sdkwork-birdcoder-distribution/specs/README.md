# SDKWork Birdcoder Distribution Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-distribution`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-distribution` |
| Type | `node-package` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-distribution` |
| Domain | `device` |
