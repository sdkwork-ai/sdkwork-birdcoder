# SDKWork Birdcoder Skills Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-skills`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-skills` |
| Type | `react-package` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-skills` |
| Domain | `intelligence` |
| Capability | `skill` |
...
- `pnpm --filter @sdkwork/birdcoder-skills typecheck`
