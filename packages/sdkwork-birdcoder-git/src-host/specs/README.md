# SDKWork Birdcoder Git Component Specs

This directory is the local standards index for `sdkwork-birdcoder-git`.
...
| Type | `rust-crate` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-git/src-host` |
| Domain | `device` |
