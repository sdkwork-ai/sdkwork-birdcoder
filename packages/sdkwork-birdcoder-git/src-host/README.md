...
This README is the SDKWork module entrypoint for `sdkwork-birdcoder-git`. The machine-readable component contract is `specs/component.spec.json`; canonical standards are under `../../../../sdkwork-specs/`.
...
- `cargo test --manifest-path apps/sdkwork-birdcoder/packages/sdkwork-birdcoder-git/src-host/Cargo.toml`
