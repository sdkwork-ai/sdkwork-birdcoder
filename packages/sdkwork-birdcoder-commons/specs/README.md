# SDKWork Birdcoder Commons Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-commons`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-commons` |
| Type | `react-tauri-package` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-commons` |
| Domain | `platform` |
