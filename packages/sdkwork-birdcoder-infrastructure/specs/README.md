...
This directory is the local standards index for `@sdkwork/birdcoder-infrastructure`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-infrastructure` |
| Type | `node-package` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-infrastructure` |
| Domain | `platform` |
