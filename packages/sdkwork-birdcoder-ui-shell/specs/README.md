...
This directory is the local standards index for `@sdkwork/birdcoder-ui-shell`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-ui-shell` |
| Type | `react-package` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-ui-shell` |
| Domain | `platform` |
| Capability | `shell` |
...
- `pnpm --filter @sdkwork/birdcoder-ui-shell typecheck`
