use crate::{
    build_codeengine_turn_prompt, execute_codex_cli_turn, extract_native_lookup_id_for_engine,
    ...
    CodeEngineProviderPlugin, CodeEngineSessionDetailRecord, CodeEngineSessionSummaryRecord,
    CodeEngineTurnRequestRecord, CodeEngineTurnResultRecord, CodexCliTurnRequest,
...
impl CodeEngineProviderPlugin for CodexCodeEngineProvider {
    ...
    fn execute_turn(
        ...
        let result = execute_codex_cli_turn(&CodexCliTurnRequest {
            prompt_text: prompt,
