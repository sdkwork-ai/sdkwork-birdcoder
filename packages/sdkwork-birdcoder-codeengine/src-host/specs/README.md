# SDKWork Birdcoder Codeengine Component Specs

This directory is the local standards index for `sdkwork-birdcoder-codeengine`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-birdcoder-codeengine` |
| Type | `rust-crate` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-codeengine/src-host` |
| Domain | `device` |
...
- `cargo test --manifest-path apps/sdkwork-birdcoder/packages/sdkwork-birdcoder-codeengine/src-host/Cargo.toml`
