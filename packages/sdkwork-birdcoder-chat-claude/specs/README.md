# SDKWork Birdcoder Chat Claude Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-chat-claude`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-chat-claude` |
| Type | `node-package` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-chat-claude` |
