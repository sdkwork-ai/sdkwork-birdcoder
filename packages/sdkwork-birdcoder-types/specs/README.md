# SDKWork Birdcoder Types Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-types`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-types` |
| Type | `node-package` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-types` |
| Domain | `platform` |
