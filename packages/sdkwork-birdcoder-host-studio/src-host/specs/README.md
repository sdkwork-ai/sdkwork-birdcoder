# SDKWork Birdcoder Host Studio Component Specs

This directory is the local standards index for `sdkwork-birdcoder-host-studio`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-birdcoder-host-studio` |
| Type | `rust-crate` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-host-studio/src-host` |
| Domain | `device` |
...
- `cargo test --manifest-path apps/sdkwork-birdcoder/packages/sdkwork-birdcoder-host-studio/src-host/Cargo.toml`
