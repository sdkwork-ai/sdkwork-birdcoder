# SDKWork Birdcoder User Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-user`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-user` |
| Type | `react-package` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-user` |
| Domain | `iam` |
| Capability | `user` |
