# SDKWork Birdcoder Server Component Specs

This directory is the local standards index for `sdkwork-birdcoder-server`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-birdcoder-server` |
| Type | `tauri-host` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-server/src-host` |
| Domain | `device` |
...
- `cargo test --manifest-path apps/sdkwork-birdcoder/packages/sdkwork-birdcoder-server/src-host/Cargo.toml`
