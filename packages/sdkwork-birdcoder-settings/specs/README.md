# SDKWork Birdcoder Settings Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-settings`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-settings` |
| Type | `react-package` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-settings` |
| Domain | `platform` |
| Capability | `settings` |
...
- `pnpm --filter @sdkwork/birdcoder-settings typecheck`
