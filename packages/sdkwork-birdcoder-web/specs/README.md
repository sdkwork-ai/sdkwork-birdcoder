# SDKWork Birdcoder Web Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-web`.
...
| Type | `react-package` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-web` |
| Domain | `platform` |
