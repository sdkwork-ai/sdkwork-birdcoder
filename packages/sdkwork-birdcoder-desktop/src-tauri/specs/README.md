# SDKWork Birdcoder Desktop Component Specs

This directory is the local standards index for `sdkwork-birdcoder-desktop`.
...
| Field | Value |
| --- | --- |
| Name | `sdkwork-birdcoder-desktop` |
| Type | `tauri-host` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-desktop/src-tauri` |
| Domain | `device` |
...
- `cargo test --manifest-path apps/sdkwork-birdcoder/packages/sdkwork-birdcoder-desktop/src-tauri/Cargo.toml`
