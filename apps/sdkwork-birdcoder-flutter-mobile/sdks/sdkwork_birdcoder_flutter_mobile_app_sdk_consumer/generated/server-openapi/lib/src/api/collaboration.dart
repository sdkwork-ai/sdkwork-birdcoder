...
class CollaborationApi {
  ...
  Future<BirdCoderTeamSummaryListEnvelope?> workspaceTeamsList([String? userId, String? workspaceId]) async {
    ...
    final response = await _client.get(ApiPaths.appendQueryString(ApiPaths.appPath('/teams'), query));
    return (() {
