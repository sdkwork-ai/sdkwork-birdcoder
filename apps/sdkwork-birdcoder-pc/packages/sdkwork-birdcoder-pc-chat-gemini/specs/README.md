# SDKWork Birdcoder Chat Gemini Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-chat-gemini`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-chat-gemini` |
| Type | `node-package` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-chat-gemini` |
