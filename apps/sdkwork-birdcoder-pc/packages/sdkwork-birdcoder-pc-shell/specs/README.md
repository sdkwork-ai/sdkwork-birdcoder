# SDKWork Birdcoder Shell Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-pc-shell`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-pc-shell` |
| Type | `react-package` |
| Root | `sdkwork-birdcoder/apps/sdkwork-birdcoder-pc/packages/sdkwork-birdcoder-pc-shell` |
| Domain | `platform` |
| Capability | `shell` |
