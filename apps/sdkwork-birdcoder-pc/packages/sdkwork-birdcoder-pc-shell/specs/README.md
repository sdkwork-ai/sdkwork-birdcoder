...
This directory is the local standards index for `@sdkwork/birdcoder-shell`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-shell` |
| Type | `react-package` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-shell` |
| Domain | `platform` |
| Capability | `shell` |
