# SDKWork Birdcoder Shell Runtime Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-pc-shell-runtime`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-pc-shell-runtime` |
| Type | `react-package` |
| Root | `sdkwork-birdcoder/apps/sdkwork-birdcoder-pc/packages/sdkwork-birdcoder-pc-shell-runtime` |
| Domain | `platform` |
