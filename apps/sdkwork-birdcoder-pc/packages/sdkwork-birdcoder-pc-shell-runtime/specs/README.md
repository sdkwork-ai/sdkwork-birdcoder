...
This directory is the local standards index for `@sdkwork/birdcoder-shell-runtime`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-shell-runtime` |
| Type | `react-package` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-shell-runtime` |
