...
export function publishBirdCoderEmbeddedSdkRuntimeEnv(apiBaseUrl: string): void {
  publishBirdCoderRuntimeEnvPatch({
    VITE_SDKWORK_BIRDCODER_APPLICATION_PUBLIC_HTTP_URL: apiBaseUrl,
    VITE_BIRDCODER_API_BASE_URL: apiBaseUrl,
    VITE_BIRDCODER_APP_API_BASE_URL: apiBaseUrl,
    VITE_BIRDCODER_BACKEND_API_BASE_URL: apiBaseUrl,
    VITE_SDKWORK_APP_API_BASE_URL: apiBaseUrl,
    VITE_SDKWORK_APPBASE_APP_API_BASE_URL: apiBaseUrl,
