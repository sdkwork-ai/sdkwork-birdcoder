...
export default defineLocaleModule('settings', {
  "settings": {
    ...
    "defaultTerminalProfileDesc": "Choose the default launch profile for the integrated terminal.",
    "language": "Language",
    "languageDesc": "App UI language",
    "sessionDetails": "Session Details",
    "sessionDetailsDesc": "Choose how much command output is shown in sessions",
