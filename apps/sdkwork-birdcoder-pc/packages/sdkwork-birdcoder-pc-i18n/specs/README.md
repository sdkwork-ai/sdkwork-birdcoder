# SDKWork Birdcoder I18n Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-i18n`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-i18n` |
| Type | `react-package` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-i18n` |
| Domain | `platform` |
