# SDKWork Birdcoder Workbench Storage Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-workbench-storage`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-workbench-storage` |
| Type | `node-package` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-workbench-storage` |
| Domain | `platform` |
