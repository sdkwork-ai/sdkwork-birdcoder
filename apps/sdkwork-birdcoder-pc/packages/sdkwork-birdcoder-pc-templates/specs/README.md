# SDKWork Birdcoder Templates Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-templates`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-templates` |
| Type | `react-package` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-templates` |
| Domain | `platform` |
