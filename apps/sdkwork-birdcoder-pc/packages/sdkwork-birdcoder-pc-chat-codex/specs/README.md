# SDKWork Birdcoder Chat Codex Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-chat-codex`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-chat-codex` |
| Type | `node-package` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-chat-codex` |
