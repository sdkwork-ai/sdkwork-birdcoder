# SDKWork Birdcoder Host Core Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-host-core`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-host-core` |
| Type | `node-package` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-host-core` |
| Domain | `device` |
