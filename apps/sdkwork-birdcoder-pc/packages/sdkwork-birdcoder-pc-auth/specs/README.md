# SDKWork Birdcoder Auth Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-auth`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-auth` |
| Type | `react-package` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-auth` |
| Domain | `iam` |
| Capability | `auth` |
