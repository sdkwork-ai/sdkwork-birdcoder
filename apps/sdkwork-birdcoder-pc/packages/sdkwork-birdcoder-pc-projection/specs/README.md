# SDKWork Birdcoder Chat Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-chat`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-chat` |
| Type | `node-package` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-chat` |
