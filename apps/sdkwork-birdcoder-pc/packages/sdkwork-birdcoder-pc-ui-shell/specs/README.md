# SDKWork Birdcoder UI Shell Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-pc-ui-shell`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-pc-ui-shell` |
| Type | `react-package` |
| Root | `sdkwork-birdcoder/apps/sdkwork-birdcoder-pc/packages/sdkwork-birdcoder-pc-ui-shell` |
| Domain | `platform` |
| Capability | `shell` |
...
The root export includes domain-neutral shell primitives and `useDialogFocusManagement`, which provides initial focus, Tab containment, Escape dismissal, and trigger-focus restoration for modal surfaces.
...
- `pnpm --filter @sdkwork/birdcoder-pc-ui-shell typecheck`
