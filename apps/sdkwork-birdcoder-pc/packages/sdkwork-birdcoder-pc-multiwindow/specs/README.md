# SDKWork Birdcoder Multiwindow Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-multiwindow`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-multiwindow` |
| Type | `react-package` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-multiwindow` |
| Domain | `platform` |
...
- `pnpm --filter @sdkwork/birdcoder-multiwindow typecheck`
