# SDKWork BirdCoder IAM Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-iam`.
...
| [IAM_SPEC.md](../../../../../specs/IAM_SPEC.md) | IAM user, session, tenant, auth, and permission domain rules. |
