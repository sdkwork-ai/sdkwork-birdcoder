...
export const BIRDCODER_FINALIZED_CODING_SERVER_OPENAPI_EVIDENCE = {
  "canonicalRelativePath": "deployments/server-windows/x64/openapi/coding-server-v1.json",
  "mirroredRelativePaths": [
    "deployments/server-windows/x64/openapi/coding-server-v1.json"
  ],
  "openapi": "3.1.0",
  "releaseTag": "development",
  "sha256": "5ff27fb5a25cf4f640f34380dadfc29daaa17f5d8e9a5d7555407066ebdfc838",
  "targetCount": 1,
  "targets": [
    "development"
  ],
