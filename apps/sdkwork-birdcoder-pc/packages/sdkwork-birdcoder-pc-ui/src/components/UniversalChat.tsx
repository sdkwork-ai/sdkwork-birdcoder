...
import { resolveBirdCoderCodeEngineCommandInteractionState } from '@sdkwork/birdcoder-pc-types';
import type { BirdCoderChatMessage, CommandExecution, FileChange } from '@sdkwork/birdcoder-pc-types';
import {
