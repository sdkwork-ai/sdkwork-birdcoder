...
export const CHAT_MESSAGE_INLINE_CODE_PROSE_CLASSNAME =
...
export const CHAT_MESSAGE_MAIN_PROSE_CLASSNAME =
  `${CHAT_MESSAGE_PROSE_CLASSNAME} ${CHAT_MESSAGE_INLINE_CODE_PROSE_CLASSNAME} prose-p:first:mt-0 prose-p:last:mb-0`;
