...
export function getResolvedBirdCoderAppApiContract(): BirdCoderAppApiContract {
  birdCoderAppApiContract ??= {
    ...
    projectWorkspaceBinding: createRoute(
      'app',
      'user',
      'GET',
    ...
    updateProjectWorkspaceBinding: createRoute(
      'app',
      'user',
      'PUT',
      '/app/v3/api/projects/:projectId/workspace_binding',
    ...
    deleteProjectWorkspaceBinding: createRoute(
      'app',
      'user',
      'DELETE',
      '/app/v3/api/projects/:projectId/workspace_binding',
    ...
    projectRuntimeLocations: createRoute(
      'app',
      'user',
      'GET',
    ...
    createProjectRuntimeLocation: createRoute(
      'app',
      'user',
      'POST',
      '/app/v3/api/projects/:projectId/runtime_locations',
    ...
    projectRuntimeLocation: createRoute(
      'app',
      'user',
      'GET',
    ...
    updateProjectRuntimeLocation: createRoute(
      'app',
      'user',
      'PATCH',
      '/app/v3/api/projects/:projectId/runtime_locations/:runtimeLocationId',
    ...
    deleteProjectRuntimeLocation: createRoute(
      'app',
      'user',
      'DELETE',
      '/app/v3/api/projects/:projectId/runtime_locations/:runtimeLocationId',
    ...
    rebindProjectRuntimeLocation: createRoute(
      'app',
      'user',
      'POST',
    ...
    requestProjectRuntimeLocationVerification: createRoute(
      'app',
      'user',
      'POST',
    ...
    projectRuntimeLocationPreferences: createRoute(
      'app',
      'user',
      'GET',
    ...
    updateProjectRuntimeLocationPreference: createRoute(
      'app',
      'user',
      'PUT',
    ...
    commerceOrders: createRoute(
      'app',
      'user',
      'GET',
      '/app/v3/api/commerce/orders',
      'List SDKWork commerce orders',
    ),
    commerceOrdersCreate: createRoute(
      'app',
      'user',
      'POST',
      '/app/v3/api/commerce/orders',
    ...
    commerceOrder: createRoute(
      'app',
      'user',
      'GET',
      '/app/v3/api/commerce/orders/:orderId',
      'Get SDKWork commerce order',
    ),
    commerceInvoices: createRoute(
      'app',
      'user',
      'GET',
      '/app/v3/api/commerce/invoices',
      'List SDKWork commerce invoices',
    ),
    commerceInvoice: createRoute(
      'app',
      'user',
      'GET',
      '/app/v3/api/commerce/invoices/:invoiceId',
      'Get SDKWork commerce invoice',
    ),
    commercePayments: createRoute(
      'app',
      'user',
      'GET',
      '/app/v3/api/commerce/payments',
      'List SDKWork commerce payments',
    ),
    commercePaymentsCreate: createRoute(
      'app',
      'user',
      'POST',
      '/app/v3/api/commerce/payments',
