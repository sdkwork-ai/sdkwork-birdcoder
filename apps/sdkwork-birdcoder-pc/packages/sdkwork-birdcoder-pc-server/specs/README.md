# SDKWork BirdCoder PC Server Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-pc-server`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-pc-server` |
| Type | `node-package` |
| Root | `sdkwork-birdcoder/apps/sdkwork-birdcoder-pc/packages/sdkwork-birdcoder-pc-server` |
| Domain | `platform` |
...
- `pnpm --filter @sdkwork/birdcoder-pc-server build`
