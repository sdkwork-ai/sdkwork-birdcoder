# SDKWork Birdcoder Infrastructure Runtime Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-infrastructure-runtime`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-infrastructure-runtime` |
| Type | `node-package` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-infrastructure-runtime` |
