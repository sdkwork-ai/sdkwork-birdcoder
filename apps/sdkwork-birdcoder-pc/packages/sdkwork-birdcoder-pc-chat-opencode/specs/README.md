# SDKWork Birdcoder Chat Opencode Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-chat-opencode`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-chat-opencode` |
| Type | `node-package` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-chat-opencode` |
