# SDKWork Birdcoder Workbench State Component Specs

This directory is the local standards index for `@sdkwork/birdcoder-workbench-state`.
...
| Field | Value |
| --- | --- |
| Name | `@sdkwork/birdcoder-workbench-state` |
| Type | `node-package` |
| Root | `sdkwork-birdcoder/packages/sdkwork-birdcoder-workbench-state` |
| Domain | `platform` |
