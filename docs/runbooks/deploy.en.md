# Runbook — sdkwork-birdcoder deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-birdcoder-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-birdcoder/bundle`, loads the image, starts
