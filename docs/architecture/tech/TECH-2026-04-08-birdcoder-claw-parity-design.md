> Migrated from `docs/superpowers/specs/2026-04-08-birdcoder-claw-parity-design.md` on 2026-06-24.
...
2. Follow SDKWork standard on foundational layers: host runtime, distribution, infrastructure, i18n, release flow, CI flow, deployment flow, and GitHub release publishing shape.
