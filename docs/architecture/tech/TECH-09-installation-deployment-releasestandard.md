...
- OpenAPI contract: **153 operations** (product routers + federated `sdkwork-iam` app/backend routers + commerce gateway routes + chat routes); **153 of 153 implemented**, **0 deferred**. Defer registry: `specs/coding-server-openapi-rust-defer-registry.json` (regenerate with `node scripts/build-coding-server-openapi-rust-defer-registry.mjs`); see `TECH-2026-06-24-commercial-readiness-alignment.md` §2b and §15.
