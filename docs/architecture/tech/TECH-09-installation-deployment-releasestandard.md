...
- OpenAPI contract: **132 operations**; api-server hosts product routers plus federated `sdkwork-iam` app/backend routers. Defer registry: **132 of 132 implemented**, **0 deferred** (`specs/coding-server-openapi-rust-defer-registry.json`).
...
- Mandatory verification for this slice:
  ...
  - `cargo test -p sdkwork-birdcoder-api-server openapi`
