> Migrated from `docs/架构/17-sdkwork-iam-auth-user-standard.md` on 2026-06-24.
...
- Rust local/private IAM uses `sdkwork_iam_context_service`, `sdkwork_routes_iam_app_api`, `sdkwork_routes_iam_backend_api`, `sdkwork_iam_directory_repository_sqlx`, and `sdkwork_iam_tauri_host`.
