> Migrated from `docs/step/17O-Default-IDE-Release-Service-Adoption-Lane.md` on 2026-06-24.
...
Close the first governed admin release consumer slice in the default IDE/app layer so release catalog reads stop ending at the shared app/backend client only.
