> Migrated from `docs/release/release-2026-04-11-18.md` on 2026-06-24.
...
- Promotes `listPolicies()` into the shared generated app/backend facade instead of faking policy governance through deployment or audit truth.
...
- Stop-ship signals: `/backend/v3/api/policies` regressing to `not_implemented`, policy reads drifting onto `deployment_records` or `audit_events`, or admin policy consumers bypassing `listPolicies()`.
...
- Writeback targets: `docs/架构/20-统一Rust-Coding-Server-API-协议标准.md`, `docs/架构/09-安装-部署-发布标准.md`, `docs/step/17-Coding-Server-App-Backend-SDK与控制台实现.md`, `docs/step/17ZB-Real-Admin-Policy-Governance-Lane.md`, `docs/prompts/反复执行Step指令.md`, `docs/release/releases.json`, and `docs/release/release-2026-04-11-18.md`.
