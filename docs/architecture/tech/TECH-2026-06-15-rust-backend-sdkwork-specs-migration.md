> Migrated from `docs/superpowers/plans/2026-06-15-rust-backend-sdkwork-specs-migration.md` on 2026-06-24.
...
**Design:**
```rust
// In standalone-gateway middleware (before route handlers):
...
# Server: sdkwork-<app>-standalone-gateway
