> Migrated from `docs/superpowers/plans/2026-04-15-birdcoder-bootstrap-recovery-implementation.md` on 2026-06-24.
...
Run: `cargo test --manifest-path crates/sdkwork-birdcoder-standalone-gateway/Cargo.toml build_app_from_sqlite_file_bootstraps_`
...
Add an idempotent helper in `crates/sdkwork-birdcoder-standalone-gateway/src/lib.rs` that:
