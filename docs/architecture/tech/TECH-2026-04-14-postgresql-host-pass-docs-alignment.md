> Migrated from `docs/superpowers/plans/2026-04-14-postgresql-host-pass-docs-alignment.md` on 2026-06-24.
...
- Modify: `docs/step/17I-Coding-Server-Shared-Generated-App/Backend-Facade-Lane.md`
- Modify: `docs/step/17J-Default-IDE-Services-Split-SDK-Adoption-Lane.md`
- Modify: `docs/step/17K-App/Backend-Wrapper-Removal-Lane.md`
- Modify: `docs/step/17L-App-Runtime-Read-SDK-Lane.md`
- Modify: `docs/step/17M-App-Runtime-Projection-Read-SDK-Lane.md`
- Modify: `docs/step/17N-App-Team-Surface-Split-Lane.md`
- Modify: `docs/step/17O-Default-IDE-Release-Service-Adoption-Lane.md`
- Modify: `docs/step/17P-Default-IDE-App-Runtime-Read-Adoption-Lane.md`
- Modify: `docs/step/17Q-App-Level-Coding-Session-Projection-Consumer-Adoption-Lane.md`
- Modify: `docs/step/17R-App-Runtime-SDK-Governance-Lane.md`
- Modify: `docs/step/17S-App-Runtime-Create-Coding-Session-Route-Lane.md`
- Modify: `docs/step/17T-App-Runtime-Create-Coding-Session-SDK-And-Consumer-Adoption-Lane.md`
- Modify: `docs/step/17U-App-Runtime-Create-Coding-Session-Turn-SDK-And-Consumer-Adoption-Lane.md`
- Modify: `docs/step/17V-App-Runtime-Engine-Capability-And-Model-Catalog-Lane.md`
- Modify: `docs/step/17W-App-Runtime-Approval-Decision-Lane.md`
