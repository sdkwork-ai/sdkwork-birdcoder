> Migrated from `docs/release/release-2026-04-11-14.md` on 2026-06-24.
...
- Promotes `listDocuments()` into the shared generated app/backend facade and shared document repository/query/transport boundary.
...
- Stop-ship signals: `/app/v3/api/documents` regressing to `not_implemented`, `project_documents` drift between legacy/direct sqlite paths, or document reads bypassing the shared facade/service boundary.
...
- Writeback targets: `docs/架构/20-统一Rust-Coding-Server-API-协议标准.md`, `docs/架构/09-安装-部署-发布标准.md`, `docs/step/17-Coding-Server-App-Backend-SDK与控制台实现.md`, `docs/step/17X-Real-App-Document-Catalog-Lane.md`, `docs/step/17Y-Real-Admin-Audit-Lane.md`, `docs/prompts/反复执行Step指令.md`, `docs/release/releases.json`, and `docs/release/release-2026-04-11-14.md`.
