> Migrated from `docs/step/17S-App-Runtime-Create-Coding-Session-Route-Lane.md` on 2026-06-24.
...
Turn `POST /app/v3/api/coding_sessions` from a `not_implemented` skeleton into a real Rust-host authority write route without prematurely promoting it into the shared high-level facade.
