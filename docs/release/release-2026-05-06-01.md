...
- Removes deprecated compatibility surfaces including the deprecated VIP route option, deprecated Codex compatibility debt, and the unused Tauri dialog permission path.
...
- Stop-ship signals: any shared SDK source checkout points to a non-main or dirty sibling repo; GitHub release workflow cannot clone `sdkwork-ui` at `6aa7d817195c231b29e9731bc4a1b2640cad13d3`; `pnpm lint`, `check:desktop`, `check:server`, `build`, `server:build`, or `docs:build` regresses in CI; release coverage becomes partial; attestation evidence is missing; or GitHub Release asset publication fails.
- Release kind: `canary`
...
- Writeback targets: `docs/release/release-2026-05-06-01.md`, `docs/release/releases.json`, `config/shared-sdk-release-sources.json`, `.github/workflows/release-reusable.yml`, and the independent `sdkwork-ui` repository commits `1bbf17c65d4fd640ceb3d43892019613eb60496b` and `6aa7d817195c231b29e9731bc4a1b2640cad13d3`.
