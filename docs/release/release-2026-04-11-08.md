...
- `cargo test --manifest-path crates/sdkwork-api-birdcoder-standalone-gateway/Cargo.toml create_coding_session_route_returns_created_session_and_makes_projection_readable`
- `cargo test --manifest-path crates/sdkwork-api-birdcoder-standalone-gateway/Cargo.toml create_coding_session_route_persists_into_sqlite_provider_authority`
