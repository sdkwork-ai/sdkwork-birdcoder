...
- `cargo test --manifest-path crates/sdkwork-api-birdcoder-standalone-gateway/Cargo.toml create_coding_session_turn_route_returns_created_turn_and_makes_projection_readable`
- `cargo test --manifest-path crates/sdkwork-api-birdcoder-standalone-gateway/Cargo.toml create_coding_session_turn_route_returns_not_found_for_missing_session`
- `cargo test --manifest-path crates/sdkwork-api-birdcoder-standalone-gateway/Cargo.toml create_coding_session_turn_route_persists_into_sqlite_provider_authority`
