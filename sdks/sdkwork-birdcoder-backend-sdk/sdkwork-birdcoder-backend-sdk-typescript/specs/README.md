...
This directory is the local SDKWork component contract for `@sdkwork/birdcoder-backend-sdk`.

- Component root: `sdkwork-birdcoder/sdks/sdkwork-birdcoder-backend-sdk/sdkwork-birdcoder-backend-sdk-typescript`
