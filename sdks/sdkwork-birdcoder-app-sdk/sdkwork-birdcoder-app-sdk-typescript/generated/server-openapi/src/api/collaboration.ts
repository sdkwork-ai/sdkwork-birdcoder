...
export class CollaborationWorkspaceTeamsApi {
...
export class CollaborationApi {
  private client: HttpClient;
  public readonly workspaceTeams: CollaborationWorkspaceTeamsApi;

  constructor(client: HttpClient) {
    this.client = client;
    this.workspaceTeams = new CollaborationWorkspaceTeamsApi(client);
  }

}

export function createCollaborationApi(client: HttpClient): CollaborationApi {
  return new CollaborationApi(client);
}
