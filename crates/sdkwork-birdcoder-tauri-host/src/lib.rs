...
pub use host::{
    ...
    setup_deeplink_handling, desktop_tray_update_menu, ensure_desktop_runtime_config,
    request_embedded_api_shutdown, spawn_embedded_application_gateway_startup,
    start_embedded_application_gateway, user_model_config_delete_channel,
    user_model_config_delete_engine_config, user_model_config_delete_engine_selection,
    user_model_config_get_api_key, user_model_config_get_channel,
    ...
    DesktopTraySessionMenuLabels, DesktopTraySessionMenuSnapshot, DeepLinkImportRequest,
    DeepLinkImportSnapshot, TauriHostState,
};
