...
pub async fn wire_repositories(pool: Arc<DatabasePool>) -> Result<Repositories, String> {
    ...
    Ok(Repositories {
        ...
        skill_package: Arc::new(SqliteSkillPackageRepository::new(any_pool.clone())),
        membership: Arc::new(SqliteMembershipRepository::new(any_pool)),
    })
}
