...
pub const SESSION_ARTIFACTS: &str = "/app/v3/api/intelligence/coding_sessions/{sessionId}/artifacts";
pub const SESSION_CHECKPOINTS: &str = "/app/v3/api/intelligence/coding_sessions/{sessionId}/checkpoints";
